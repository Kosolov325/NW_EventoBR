...
void main ()
{
  ...
  specColor_8 = ((tmpvar_4 * dot (texture2D (specular_texture, Tex0).xyz, vec3(0.33, 0.33, 0.33))) * ((1.65 * tmpvar_10) * spec_coef));
  vec4 tmpvar_11;
  tmpvar_11.w = 1.0;
  ...
  fSpecular_9.xyz = (fSpecular_9.xyz + ((specColor_8.xyz * texture2D (env_texture, 
    ((ViewDir - normal_3).yz + 1.0)
  ).xyz) * 0.039));
