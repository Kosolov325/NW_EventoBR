...
void main ()
{
  ...
  vec4 tmpvar_11;
  vec3 tmpvar_12;
  if ((((inTexCoord.y >= 0.07) && (inTexCoord.y <= 0.93)) || ((
    (inTexCoord.y <= 0.07)
   || 
    (inTexCoord.y >= 0.93)
  ) && (
   ...
   && 
    ...
    Position2_14.w = nextPos_13.w;
    float tmpvar_16;
    tmpvar_16 = (time_var * 2.5);
    float tmpvar_17;
    tmpvar_17 = (time_var * 0.2);
    float tmpvar_18;
    tmpvar_18 = (inPosition.x * 0.0112);
    vPosition_2.xyz = (inPosition + vec3(((
      sin(((tmpvar_16 + inPosition.z) + (inPosition.y - inPosition.x)))
     * tmpvar_18) * sin(tmpvar_17))));
    Position1_15.xyz = (Position1_15.xyz + vec3(((
      sin(((tmpvar_16 + Position1_15.z) + (Position1_15.y - Position1_15.x)))
     * 
      (Position1_15.x * 0.0112)
    ) * sin(tmpvar_17))));
    Position2_14.xyz = (nextPos_13.xyz + vec3(((
      sin(((tmpvar_16 + inPosition.z) + (nextPos_13.y - inPosition.x)))
     * tmpvar_18) * sin(tmpvar_17))));
    vec3 a_19;
