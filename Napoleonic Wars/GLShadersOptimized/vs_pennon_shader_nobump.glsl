...
void main ()
{
  ...
  Position2_12.xyw = nextPos_11.xyw;
  float tmpvar_14;
  tmpvar_14 = (time_var * 9.0);
  float tmpvar_15;
  tmpvar_15 = (inPosition.x * 0.33);
  vPosition_2.z = (inPosition.z + (sin(
    ((tmpvar_14 + inPosition.z) + (inPosition.y - inPosition.x))
  ) * tmpvar_15));
  Position1_13.z = (Position1_13.z + (sin(
    ((tmpvar_14 + Position1_13.z) + (Position1_13.y - Position1_13.x))
  ) * (Position1_13.x * 0.33)));
  Position2_12.z = (inPosition.z + (sin(
    ((tmpvar_14 + inPosition.z) + (nextPos_11.y - inPosition.x))
  ) * tmpvar_15));
  vec3 a_16;
