...
void main ()
{
  ...
  if ((((inTexCoord.y >= 0.07) && (inTexCoord.y <= 0.93)) || ((
   ...
   && 
    ...
    Position2_12.w = nextPos_11.w;
    float tmpvar_14;
    tmpvar_14 = (time_var * 2.5);
    float tmpvar_15;
    tmpvar_15 = (time_var * 0.2);
    float tmpvar_16;
    tmpvar_16 = (inPosition.x * 0.0112);
    vPosition_2.xyz = (inPosition + vec3(((
      sin(((tmpvar_14 + inPosition.z) + (inPosition.y - inPosition.x)))
     * tmpvar_16) * sin(tmpvar_15))));
    Position1_13.xyz = (Position1_13.xyz + vec3(((
      sin(((tmpvar_14 + Position1_13.z) + (Position1_13.y - Position1_13.x)))
     * 
      (Position1_13.x * 0.0112)
    ) * sin(tmpvar_15))));
    Position2_12.xyz = (nextPos_11.xyz + vec3(((
      sin(((tmpvar_14 + inPosition.z) + (nextPos_11.y - inPosition.x)))
     * tmpvar_16) * sin(tmpvar_15))));
    vec3 a_17;
