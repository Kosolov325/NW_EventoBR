...
{ 
	...
	//alpha_test_val = 0.05;
	gl_FragColor = ps_main_standart(VSOut, CURRENT_PCF_MODE,  false, false, false, false, false, true).RGBColor;
	
	if((gl_FragColor.a - alpha_test_val) < 0.0) //enforcing alpha testing on flora shaders
		discard;
