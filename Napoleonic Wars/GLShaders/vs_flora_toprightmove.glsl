...
VS_OUTPUT_FLORA vs_flora_toprightmove(int PcfMode, float4 vPosition, float4 vColor, float2 tc)
{
	VS_OUTPUT_FLORA Out;
...
void main()
{
	...
	//VSOut = vs_flora_toprightmove(CURRENT_PCF_MODE, vec4(inPosition, 1.0), inColor0, inTexCoord);
